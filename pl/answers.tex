...
\begin{itemize}
 ...
 \item Serwera pocztowego udostępnianego np. przez \texttt{interia.pl}, gdzie \texttt{poczta.interia.pl} jest adresem serwera SMTP, \texttt{465} jest numerem portu, na którym działa serwer. Potrzebujesz również konta na serwerze - możesz użyć adresu: \texttt{pas.umcs@poczta.fm} z hasłem: \texttt{PasUmcs@2023}.
 \end{itemize}
